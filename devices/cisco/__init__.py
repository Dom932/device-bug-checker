...
from devices.cisco.cisco_ios_ssh_telnet import CiscoIOSSSHTelnet
from devices.cisco.cisco_wlc import CiscoWLC
from devices.cisco.cisco_asa import CiscoASA
from devices.cisco.cisco_nxos import CiscoNXOS
