...
class TestCiscoIOS:
    ...
    def test_instance(self, device):
        ...
        assert isinstance(device, CiscoIOSSSHTelnet)
        assert isinstance(device, CiscoIOS)
    ...
    def test_device_type(self, device):
        """ Test device_type """
        assert device.device_type == ("cisco_ios", "cisco_ios_telnet")
